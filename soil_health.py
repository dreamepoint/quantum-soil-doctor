...
# ---------------------------------------------------------
# 2. Advanced PDF Generation Engine
# ---------------------------------------------------------
def generate_pdf_report(crop, n, p, k, ph, n_msg, p_msg, k_msg, ph_msg, is_hi):
    ...
    pdf.cell(180, 8, "AGRIQN - BUSINESS SOLUTION", new_x="LMARGIN", new_y="NEXT", align="C")
    ...
    pdf.cell(180, 5, f"{'रिपोर्ट आईडी' if is_hi else 'Report ID'}: AGRIQN-SOIL-{int(time.time())}", new_x="LMARGIN", new_y="NEXT")
    ...
    foot_text = "* यह एक स्वचालित रिपोर्ट है जो AGRIQN क्वांटम सर्किट सिमुलेटर द्वारा तैयार की गई है।" if is_hi else "* Automated report generated via AGRIQN Quantum Circuit Simulators."
...
# ---------------------------------------------------------
# 3. Main Function Handler to Render Module
# ---------------------------------------------------------
def render_soil_module(is_hindi):
    st.markdown("<h1>AGRIQN AI</h1>", unsafe_allow_html=True)
    ...
    with tab_app:
        crops_dict = {
            True: ["कपास (Cotton)", "धान (Rice)", "गेहूं (Wheat)"],
            False: ["Cotton", "Rice", "Wheat"]
        }
